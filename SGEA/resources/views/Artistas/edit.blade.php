<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">{{ __('Edit Artistas') }}</h2>
    </x-slot>
                    ...
                    <div class="container">
                        ...
                        <form method="POST" action="{{ route('artistas.update', ['artista' => $artistas->id]) }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="code" name="code" aria-describedby="id" disabled="disabled" value="{{ $artistas->id }}">
